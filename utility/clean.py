'''
Open3d api expects point cloud to be seperated by space, but our training script parses it with "," as seperator. So we convert all "," to " " for open3d api
to read point cloud and augment with normals.
